...
function custom_password_form() {
	...
	' . '<p>' . __( "Please enter the MK Member Password" ,'wpbootstrap') . '</p>' . '
	<label style="display: none;" for="' . $label . '">' . __( "Password:" ,'wpbootstrap') . ' </label><div class="input-append"><input class="bootstrap_input" name="post_password" id="' . $label . '" type="password" size="20" /><input style="margin-left:10px;" type="submit" name="Submit" class="btn btn-warning" value="' . esc_attr__( "Submit",'wpbootstrap' ) . '" /></div>
	</form></div>
	';
	return $o;
}
